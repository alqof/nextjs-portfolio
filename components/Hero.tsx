    ...
    return (
        <section id="home">
            <div className="pb-20 pt-36">
                ...
                <div className="absolute top-0 left-0 h-screen w-full flex items-center justify-center bg-white dark:bg-red-main bg-grid-black-100/[0.2] dark:bg-grid-white/[0.1]">
                    <div className="absolute flex items-center justify-center dark:bg-red-main bg-white pointer-events-none inset-0 [mask-image:radial-gradient(ellipse_at_center,transparent_15%,black)]"/>
                </div>
    
                <div className="relative my-40 md:my-20 z-10 flex justify-center">
                    <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center gap-y-3">
                        ...
                        <TextGenerateEffect words="Transforming Concepts into Seamless User Experiences" className="text-center text-3xl md:text-5xl lg:text-6xl"/>
